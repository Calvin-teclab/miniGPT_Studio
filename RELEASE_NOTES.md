...
This release is focused on making `miniGPT Studio` safer to run, easier to recover from setup mistakes, and more dependable on a 24 GB Apple Silicon laptop.
