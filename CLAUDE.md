...
miniGPT Studio is a self-contained local GPT training studio for Apple Silicon, built on an MLX pipeline inspired by Karpathy's nanochat. Full pipeline from data download to chat and music generation, no PyTorch required.
